    ...
    template:
        '<tr >'+
            '<div v-if="tezis.tezisStatus==2" class="card mx-auto" style="margin: 25px;">'+
                '<h5 v-if="tezis.tezisType==1" class="card-header text-white bg-danger" >#{{this.teziss.indexOf(this.tezis)+1}} Тезис</h5>'+
                '<h5 v-if="tezis.tezisType==2" class="card-header text-white bg-danger" >#{{this.teziss.indexOf(this.tezis)+1}} Доклад</h5>'+
                '<div class="card-body">'+
...
Vue.component('teziss-list', {
    ...
    template:
        ...
        '<h1>Отклоненные заявки для участия в коныеренции</h1>'+

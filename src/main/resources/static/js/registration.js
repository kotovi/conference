    ...
    template:
      '<div>'+
        ...
        '<div style="background: #fff;">'+
                        '<h1 class="display-4 mt-5 mb-5" style="padding-top:40px;">Регистрация участника конференции</h1>'+
                    '</div>'+
                    '<div class="card">'+
                        '<h5 class="text-white  card-header" style="background: #293f50;">Ввод данных для регистрации участника</h5>'+
                        '<div class="card-body">'+
                        '<form>'+
                            '<div class="form-row">'+
                            ...
                            '<div class="form-group row">'+
                                '<div class="col-sm-10">'+
                                    '<input v-if="($root.editClicked == false)" type="button"  class="btn btn-outline-light" style="background: #293f50; margin-top: 20px;" value="Зарегистрироваться" @click="save"/>'+
                                '</div>'+
                            '</div>'+
                        '</form>'+
                    '</div>'+
